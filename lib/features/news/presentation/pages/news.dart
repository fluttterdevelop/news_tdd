...
import 'package:news_tdd/features/news/data/model/news_article/news_article.dart';
import 'package:news_tdd/features/news/presentation/bloc/news/news_bloc.dart';
        ...
        return Scaffold(
          ...
          body: ListView(
            children: [
              ...
              Text(article.contant), // Use the article's content property
            ],
          ),
        );
      }),
